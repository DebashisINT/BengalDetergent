package com.bengaldetergentfsm.features.permissionList
...
import com.bengaldetergentfsm.test.viewPermission.AdapterViewPermission
        ...
        for(i in 0..list.size-1){
            if(list1.get(i)!="android.permission.ACCESS_GPS") {
                var obj: PermissionDetails = PermissionDetails(list1.get(i).replace("android.permission.", "").replace("_", " ")
                        ...
                        replace("com.bengaldetergentfsm.permission.C2D",""), list.get(i))
