package com.bengaldetergentfsm.features.dashboard.presentation
...
import com.bengaldetergentfsm.*
import com.bengaldetergentfsm.ContactUtils.retrieveAllContacts
import com.bengaldetergentfsm.R
import com.bengaldetergentfsm.app.*
import com.bengaldetergentfsm.app.NewFileUtils.browseDocuments
import com.bengaldetergentfsm.app.NewFileUtils.getExtension
import com.bengaldetergentfsm.app.domain.*
import com.bengaldetergentfsm.app.types.DashboardType
import com.bengaldetergentfsm.app.types.FragType
import com.bengaldetergentfsm.app.types.TopBarConfig
import com.bengaldetergentfsm.app.uiaction.DisplayAlert
import com.bengaldetergentfsm.app.utils.*
import com.bengaldetergentfsm.app.utils.AppUtils.Companion.isProfile
...
import com.bengaldetergentfsm.features.NewQuotation.*
import com.bengaldetergentfsm.features.NewQuotation.api.GetQuotRegProvider
import com.bengaldetergentfsm.features.NewQuotation.model.ViewDetailsQuotResponse
import com.bengaldetergentfsm.features.NewQuotation.model.shop_wise_quotation_list
import com.bengaldetergentfsm.features.SearchLocation.SearchLocationFragment
import com.bengaldetergentfsm.features.SearchLocation.locationInfoModel
import com.bengaldetergentfsm.features.TA.ViewAllTAListFragment
import com.bengaldetergentfsm.features.achievement.AchievementFragment
import com.bengaldetergentfsm.features.activities.presentation.*
import com.bengaldetergentfsm.features.addAttendence.*
import com.bengaldetergentfsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.bengaldetergentfsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.bengaldetergentfsm.features.addAttendence.model.GetReportToFCMResponse
import com.bengaldetergentfsm.features.addAttendence.model.GetReportToResponse
import com.bengaldetergentfsm.features.addAttendence.model.Leave_list_Response
import com.bengaldetergentfsm.features.addorder.presentation.AddOrderFragment
...
import com.bengaldetergentfsm.features.addshop.presentation.AddShopFragment
import com.bengaldetergentfsm.features.addshop.presentation.OTPVerificationDialog
import com.bengaldetergentfsm.features.addshop.presentation.ScanImageFragment
import com.bengaldetergentfsm.features.addshop.presentation.ShowCardDetailsDialog
import com.bengaldetergentfsm.features.alarm.model.AlarmData
import com.bengaldetergentfsm.features.alarm.presetation.AttendanceReportFragment
import com.bengaldetergentfsm.features.alarm.presetation.PerformanceReportFragment
import com.bengaldetergentfsm.features.alarm.presetation.VisitReportDetailsFragment
import com.bengaldetergentfsm.features.alarm.presetation.VisitReportFragment
import com.bengaldetergentfsm.features.attendance.AttendanceFragment
import com.bengaldetergentfsm.features.attendance.api.AttendanceRepositoryProvider
import com.bengaldetergentfsm.features.attendance.model.AttendanceRequest
import com.bengaldetergentfsm.features.attendance.model.AttendanceResponse
import com.bengaldetergentfsm.features.averageshop.presentation.AverageShopFragment
import com.bengaldetergentfsm.features.avgorder.presentation.AverageOrderFragment
import com.bengaldetergentfsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.bengaldetergentfsm.features.beatCustom.TeamBeatListFragment
import com.bengaldetergentfsm.features.billing.presentation.AddBillingFragment
import com.bengaldetergentfsm.features.billing.presentation.BillingDetailsFragment
import com.bengaldetergentfsm.features.billing.presentation.BillingListFragment
import com.bengaldetergentfsm.features.changepassword.presentation.ChangePasswordDialog
import com.bengaldetergentfsm.features.chat.model.ChatListDataModel
import com.bengaldetergentfsm.features.chat.model.ChatUserDataModel
import com.bengaldetergentfsm.features.chat.model.GroupUserDataModel
import com.bengaldetergentfsm.features.chat.presentation.*
import com.bengaldetergentfsm.features.chatbot.presentation.ChatBotFragment
import com.bengaldetergentfsm.features.chatbot.presentation.ChatBotShopListFragment
import com.bengaldetergentfsm.features.chatbot.presentation.ReportsFragment
import com.bengaldetergentfsm.features.chatbot.presentation.SelectLanguageDialog
import com.bengaldetergentfsm.features.commondialog.presentation.CommonDialog
import com.bengaldetergentfsm.features.commondialog.presentation.CommonDialogClickListener
import com.bengaldetergentfsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.bengaldetergentfsm.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.bengaldetergentfsm.features.commondialogsinglebtn.OnDialogClickListener
import com.bengaldetergentfsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.bengaldetergentfsm.features.dailyPlan.prsentation.AllShopListFragment
import com.bengaldetergentfsm.features.dailyPlan.prsentation.DailyPlanListFragment
import com.bengaldetergentfsm.features.dailyPlan.prsentation.PlanDetailsFragment
import com.bengaldetergentfsm.features.damageProduct.ShopDamageProductListFrag
import com.bengaldetergentfsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.bengaldetergentfsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.bengaldetergentfsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.bengaldetergentfsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.bengaldetergentfsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.bengaldetergentfsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.bengaldetergentfsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.bengaldetergentfsm.features.dashboard.presentation.model.ContentListResponseModel
import com.bengaldetergentfsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.bengaldetergentfsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.bengaldetergentfsm.features.device_info.presentation.DeviceInfoListFragment
import com.bengaldetergentfsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.bengaldetergentfsm.features.document.DocumentRepoFeatureNewFragment
import com.bengaldetergentfsm.features.document.presentation.DocumentListFragment
import com.bengaldetergentfsm.features.document.presentation.DocumentTypeListFragment
import com.bengaldetergentfsm.features.document.presentation.OpenFileWebViewFragment
import com.bengaldetergentfsm.features.dymanicSection.presentation.AddDynamicFragment
import com.bengaldetergentfsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.bengaldetergentfsm.features.dymanicSection.presentation.DynamicListFragment
import com.bengaldetergentfsm.features.dymanicSection.presentation.EditDynamicFragment
import com.bengaldetergentfsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.bengaldetergentfsm.features.home.presentation.HomeFragment
import com.bengaldetergentfsm.features.homelocation.presentation.HomeLocationFragment
import com.bengaldetergentfsm.features.homelocation.presentation.HomeLocationMapFragment
import com.bengaldetergentfsm.features.know_your_state.KnowYourStateFragment
import com.bengaldetergentfsm.features.lead.LeadFrag
import com.bengaldetergentfsm.features.lead.ViewLeadFrag
import com.bengaldetergentfsm.features.leaveapplynew.LeaveHome
import com.bengaldetergentfsm.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.bengaldetergentfsm.features.localshops.LocalShopListFragment
import com.bengaldetergentfsm.features.localshops.LocalShopListMapFragment
import com.bengaldetergentfsm.features.localshops.NearByShopsMapFragment
import com.bengaldetergentfsm.features.location.*
import com.bengaldetergentfsm.features.location.api.LocationRepoProvider
import com.bengaldetergentfsm.features.location.model.*
import com.bengaldetergentfsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.bengaldetergentfsm.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.bengaldetergentfsm.features.login.ShopFeedbackEntity
import com.bengaldetergentfsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.bengaldetergentfsm.features.login.presentation.LoginActivity
import com.bengaldetergentfsm.features.logout.presentation.api.LogoutRepositoryProvider
import com.bengaldetergentfsm.features.logoutsync.presentation.LogoutSyncFragment
import com.bengaldetergentfsm.features.marketing.presentation.MarketingPagerFragment
import com.bengaldetergentfsm.features.meetinglist.prsentation.MeetingListFragment
import com.bengaldetergentfsm.features.member.MapViewForTeamFrag
import com.bengaldetergentfsm.features.member.model.TeamLocDataModel
import com.bengaldetergentfsm.features.member.model.TeamShopListDataModel
import com.bengaldetergentfsm.features.member.presentation.*
import com.bengaldetergentfsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.bengaldetergentfsm.features.micro_learning.presentation.MicroLearningListFragment
import com.bengaldetergentfsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.bengaldetergentfsm.features.myallowancerequest.MyallowanceRequestFragment
import com.bengaldetergentfsm.features.myjobs.model.CustomerDataModel
import com.bengaldetergentfsm.features.myjobs.presentation.*
import com.bengaldetergentfsm.features.myorder.presentation.MyOrderListFragment
import com.bengaldetergentfsm.features.myprofile.presentation.MyProfileFragment
import com.bengaldetergentfsm.features.nearbyshops.api.ShopListRepositoryProvider
import com.bengaldetergentfsm.features.nearbyshops.model.ShopData
import com.bengaldetergentfsm.features.nearbyshops.model.ShopListResponse
import com.bengaldetergentfsm.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.bengaldetergentfsm.features.nearbyshops.presentation.BeatListFragment
import com.bengaldetergentfsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.bengaldetergentfsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.bengaldetergentfsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.bengaldetergentfsm.features.newcollection.CollectionDetailsStatusFragment
import com.bengaldetergentfsm.features.newcollection.CollectionShopListFragment
import com.bengaldetergentfsm.features.newcollection.NewCollectionListFragment
import com.bengaldetergentfsm.features.newcollectionreport.*
import com.bengaldetergentfsm.features.notification.NotificationFragment
import com.bengaldetergentfsm.features.orderList.NewDateWiseOrderListFragment
import com.bengaldetergentfsm.features.orderList.NewOrderListFragment
import com.bengaldetergentfsm.features.orderList.OrderListFragment
import com.bengaldetergentfsm.features.orderdetail.presentation.OrderDetailFragment
import com.bengaldetergentfsm.features.orderhistory.ActivityMapFragment
import com.bengaldetergentfsm.features.orderhistory.OrderhistoryFragment
import com.bengaldetergentfsm.features.orderhistory.TimeLineFragment
import com.bengaldetergentfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.bengaldetergentfsm.features.orderhistory.model.LocationData
import com.bengaldetergentfsm.features.pendinglocationinout.PendingOutLocationFrag
import com.bengaldetergentfsm.features.performance.GpsStatusFragment
import com.bengaldetergentfsm.features.performance.PerformanceFragment
import com.bengaldetergentfsm.features.performance.api.UpdateGpsStatusRepoProvider
import com.bengaldetergentfsm.features.performance.model.UpdateGpsInputParamsModel
import com.bengaldetergentfsm.features.permissionList.ViewPermissionFragment
import com.bengaldetergentfsm.features.photoReg.*
import com.bengaldetergentfsm.features.quotation.presentation.*
import com.bengaldetergentfsm.features.reimbursement.presentation.EditReimbursementFragment
import com.bengaldetergentfsm.features.reimbursement.presentation.ReimbursementDetailsFragment
import com.bengaldetergentfsm.features.reimbursement.presentation.ReimbursementFragment
import com.bengaldetergentfsm.features.reimbursement.presentation.ReimbursementListFragment
import com.bengaldetergentfsm.features.report.presentation.*
import com.bengaldetergentfsm.features.returnsOrder.*
import com.bengaldetergentfsm.features.settings.presentation.SettingsFragment
import com.bengaldetergentfsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.bengaldetergentfsm.features.shopdetail.presentation.*
import com.bengaldetergentfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.bengaldetergentfsm.features.stock.StockDetailsFragment
import com.bengaldetergentfsm.features.stock.StockListFragment
import com.bengaldetergentfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.bengaldetergentfsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.bengaldetergentfsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.bengaldetergentfsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.bengaldetergentfsm.features.stockCompetetorStock.CompetetorStockFragment
import com.bengaldetergentfsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.bengaldetergentfsm.features.survey.SurveyFrag
import com.bengaldetergentfsm.features.survey.SurveyViewDtlsFrag
import com.bengaldetergentfsm.features.survey.SurveyViewFrag
import com.bengaldetergentfsm.features.task.presentation.AddTaskFragment
import com.bengaldetergentfsm.features.task.presentation.CalenderTaskFragment
import com.bengaldetergentfsm.features.task.presentation.EditTaskFragment
import com.bengaldetergentfsm.features.task.presentation.TaskListFragment
import com.bengaldetergentfsm.features.timesheet.presentation.AddTimeSheetFragment
import com.bengaldetergentfsm.features.timesheet.presentation.EditTimeSheetFragment
import com.bengaldetergentfsm.features.timesheet.presentation.TimeSheetListFragment
import com.bengaldetergentfsm.features.viewAllOrder.CartFragment
import com.bengaldetergentfsm.features.viewAllOrder.OrderTypeListFragment
import com.bengaldetergentfsm.features.viewAllOrder.ViewAllOrderListFragment
import com.bengaldetergentfsm.features.viewAllOrder.ViewCartFragment
import com.bengaldetergentfsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.bengaldetergentfsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.bengaldetergentfsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.bengaldetergentfsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.bengaldetergentfsm.features.viewPPDDStock.ViewOutstandingFragment
import com.bengaldetergentfsm.features.viewPPDDStock.ViewPPDDListFragment
import com.bengaldetergentfsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.bengaldetergentfsm.features.viewPPDDStock.ViewStockFragment
import com.bengaldetergentfsm.features.weather.presentation.WeatherFragment
import com.bengaldetergentfsm.mappackage.MapActivity
import com.bengaldetergentfsm.mappackage.MapActivityWithoutPath
import com.bengaldetergentfsm.mappackage.SendBrod
import com.bengaldetergentfsm.widgets.AppCustomEditText
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbengaldetergentfsmlogsample/log").path);
            //27-09-2021
            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbengaldetergentfsmlogsample/log").path);
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbengaldetergentfsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbengaldetergentfsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbengaldetergentfsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbengaldetergentfsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
