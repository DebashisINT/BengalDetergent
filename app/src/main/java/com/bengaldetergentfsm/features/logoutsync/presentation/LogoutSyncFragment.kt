package com.bengaldetergentfsm.features.logoutsync.presentation
...
import com.bengaldetergentfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.bengaldetergentfsm.features.addshop.api.AddShopRepositoryProvider
import com.bengaldetergentfsm.features.billing.api.AddBillingRepoProvider
import com.bengaldetergentfsm.features.billing.model.AddBillingInputParamsModel
...
import com.bengaldetergentfsm.features.dashboard.presentation.ReasonDialog
...
import com.bengaldetergentfsm.features.document.model.AddEditDocumentInputParams
import com.bengaldetergentfsm.features.document.model.DocumentAttachmentModel
...
import com.bengaldetergentfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.bengaldetergentfsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.bengaldetergentfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.bengaldetergentfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.bengaldetergentfsm.features.orderhistory.model.*
...
import com.bengaldetergentfsm.features.quotation.model.AddQuotInputModel
import com.bengaldetergentfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.bengaldetergentfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.bengaldetergentfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.bengaldetergentfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.bengaldetergentfsm.features.timesheet.model.AddTimeSheetInputModel
import com.bengaldetergentfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.bengaldetergentfsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.bengaldetergentfsm.features.viewAllOrder.model.AddOrderInputProductList
import com.bengaldetergentfsm.mappackage.SendBrod
import com.bengaldetergentfsm.widgets.AppCustomTextView
import com.bengaldetergentfsm.MonitorService
import com.bengaldetergentfsm.features.addshop.model.*
import com.bengaldetergentfsm.features.addshop.model.assigntopplist.AddShopUploadImg
import com.bengaldetergentfsm.features.login.api.LoginRepositoryProvider
import com.bengaldetergentfsm.features.login.model.GetConcurrentUserResponse
import com.bengaldetergentfsm.features.returnsOrder.ReturnProductList
import com.bengaldetergentfsm.features.returnsOrder.ReturnRequest
import com.bengaldetergentfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbengaldetergentfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbengaldetergentfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbengaldetergentfsmlogsample/log.zip").path);
